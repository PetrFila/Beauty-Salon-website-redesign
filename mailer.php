...
try {
    ...
    $mail->Host = 'smtp.email.com';                       // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'youraddress@email.com'; //getenv('EMAIL');                 // SMTP username
    $mail->Password = 'password'; //getenv('PASS');                           // SMTP password
